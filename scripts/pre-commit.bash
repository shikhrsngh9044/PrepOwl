...
# To create new pre-commit delete pre-commit file in .git/hooks/pre-commit and following command
#? cmd: chmod +x scripts/*.bash && ./scripts/install-hooks.bash

# To avoid running pre-commit hook
#? cmd: git commit -m "test commit" --no-verify 